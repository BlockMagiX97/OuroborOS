...
extern bool acquireTryLockWithFlags(spinlock_t *sl, flags_t *flags);
extern void releaseLock(spinlock_t *sl);
extern void releaseLockWithFlags(spinlock_t *sl, flags_t *flags);
...
extern void acquireReadLockWithFlags(rwspinlock_t *sl, flags_t *flags);
extern void releaseReadLock(rwspinlock_t *sl);
extern void releaseReadLockWithFlags(rwspinlock_t *sl, flags_t *flags);

extern void acquireWriteLock(rwspinlock_t *sl);
extern void acquireWriteLockWithFlags(rwspinlock_t *sl, flags_t *flags);
extern void releaseWriteLock(rwspinlock_t *sl);
extern void releaseWriteLockWithFlags(rwspinlock_t *sl, flags_t *flags);
